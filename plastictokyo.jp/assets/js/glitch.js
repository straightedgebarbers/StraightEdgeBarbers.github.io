'use strict';
function setGlitch($obj,$target,path) {

var intervaltime = Math.floor(Math.random()*3 + 5);
var innerW = $target.width();
var innerH = $target.height();
...
var BackgroundImage = function () {
  function BackgroundImage() {
    ...
    this.uniforms = {
      resolution: {
        type: 'v2',
        value: new THREE.Vector2(innerW, innerH)
      },
      imageResolution: {
        type: 'v2',
        value: new THREE.Vector2(300, 450)
      },
      texture: {
        type: 't',
        value: null
  ...
  BackgroundImage.prototype.resize = function resize() {
	innerW = $target.width();
	innerH = $target.height();
    this.uniforms.resolution.value.set(innerW, innerH);
  };
...
var renderBack1 = new THREE.WebGLRenderTarget(innerW, innerH);
var scene = new THREE.Scene();
var sceneBack = new THREE.Scene();
var camera = new THREE.OrthographicCamera(-1, 1, 1, -1, 0, 1);
var cameraBack = new THREE.PerspectiveCamera(45, innerW / innerH, 1, 10000);
...
var resizeWindow = function resizeWindow() {
  ...
  cameraBack.aspect = innerW / innerH;
  cameraBack.updateProjectionMatrix();
  bgImg.resize();
  postEffect.resize();
  renderBack1.setSize(innerW, innerH);
