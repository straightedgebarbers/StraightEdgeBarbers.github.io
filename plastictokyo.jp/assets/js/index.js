...
var BackgroundImage = function () {
  function BackgroundImage() {
    _classCallCheck(this, BackgroundImage);
	 var imgSizeW = 1700, imgSizeH = 1000;
	 if(window.innerWidth <= 767) imgSizeW = 640, imgSizeH = 962;
    this.uniforms = {
      resolution: {
        type: 'v2',
      ...
      imageResolution: {
        type: 'v2',
        value: new THREE.Vector2(imgSizeW, imgSizeH)
      },
      texture: {
        type: 't',
        value: null
...
var file = "";
	...
	var dir = "2017aw";
  bgImg.init('assets/img/top/' + dir + '/top' + num + file + '.jpg', function () {
